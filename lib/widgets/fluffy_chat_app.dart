...
import 'package:coursebubble/config/routes.dart';
import 'package:coursebubble/config/themes.dart';
import 'package:coursebubble/widgets/theme_builder.dart';
...
class FluffyChatAppState extends State<FluffyChatApp> {
  ...
  void initState() {
    super.initState();
    _initialUrl =
        widget.clients.any((client) => client.isLogged()) ? '/rooms' : '/login';
  }
