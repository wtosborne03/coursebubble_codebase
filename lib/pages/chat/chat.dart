...
import 'package:coursebubble/pages/chat/chat_view.dart';
import 'package:coursebubble/pages/chat/event_info_dialog.dart';
import 'package:coursebubble/pages/chat/recording_dialog.dart';
import 'package:coursebubble/utils/adaptive_bottom_sheet.dart';
import 'package:coursebubble/utils/error_reporter.dart';
import 'package:coursebubble/utils/matrix_sdk_extensions/event_extension.dart';
import 'package:coursebubble/utils/matrix_sdk_extensions/ios_badge_client_extension.dart';
...
class ChatController extends State<ChatPageWithRoom> {
  ...
  @override
  void initState() {
    AwesomeNotifications().cancel(roomId.hashCode);
    print(roomId.hashCode);
