            ...
            itemBuilder: (BuildContext context, int i) {
              ...
              if (event != null && event.content['pack'] is Map) {
                if ((event.content['pack']
                    as Map<String, dynamic>)['displayname'] is String) {
                  packName = (event.content['pack']
                      as Map<String, dynamic>)['displayname'];
                } else if ((event.content['pack']
                    as Map<String, dynamic>)['name'] is String) {
                  packName =
                      (event.content['pack'] as Map<String, dynamic>)['name'];
                }
              }
              return ListTile(
                title: Text(packName!),
