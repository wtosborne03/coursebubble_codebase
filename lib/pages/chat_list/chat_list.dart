...
import 'package:coursebubble/pages/chat_list/chat_list_view.dart';
import 'package:coursebubble/pages/settings_security/settings_security.dart';
import 'package:coursebubble/utils/famedlysdk_store.dart';
...
import 'package:coursebubble/utils/tor_stub.dart'
...
class ChatListController extends State<ChatList>
  ...
  void viewAssignments() {
    VRouter.of(context).to('/rooms/assignments');
  }
  ...
  static const String _serverStoreNamespace =
      'matrix.coursebubble.online.search.server';
  ...
  void _processIncomingSharedFiles(List<SharedMediaFile> files) {
    ...
    Matrix.of(context).shareContent = {
      'msgtype': 'chat.coursebubble.shared_file',
      'file': MatrixFile(
