...
import 'package:coursebubble/config/isrg_x1.dart';
...
import 'package:coursebubble/utils/room_status_extension.dart';
...
class ChatListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    dynamic roomData = {};
    if (room.topic.contains('/*/*/'))
      roomData = jsonDecode(room.topic.split('/*/*/')[1]);
            ...
            children: <Widget>[
              Expanded(
                child: Text(
                  ...
                  softWrap: false,
                  style: TextStyle(
                      fontWeight: unread ? FontWeight.w900 : FontWeight.w900,
                      decoration: unread ? TextDecoration.underline : null,
...
class ChatListSpecial extends StatelessWidget {
  final bool activeChat;
  final bool selected;
  final void Function()? onTap;
  final void Function()? onLongPress;

  const ChatListSpecial({
    this.activeChat = false,
    this.selected = false,
    this.onTap,
    this.onLongPress,
  ...
  @override
  Widget build(BuildContext context) {
    final displayname = "Upcoming Assignments";
    return Padding(
      padding: const EdgeInsets.symmetric(
        horizontal: 8,
        vertical: 2,
